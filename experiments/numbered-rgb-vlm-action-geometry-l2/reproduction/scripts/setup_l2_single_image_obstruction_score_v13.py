#!/usr/bin/env python3
"""Create a one-image, per-object 0--10 obstruction-score experiment."""
...
DESTINATION = ROOT / "experiments/vlm_action_geometry_single_info_l2_single_image_obstruction_score_v13"
...
Return only valid JSON."""
    prompt = """The robot must grasp target object 43.

Score how much removing {candidate_description} would improve the robot's ability
to grasp the target.
...
{"obstruction_score": <integer>}"""
    ...
    config = {
        "experiment_version": "l2_single_image_obstruction_score_v13",
        "l2_prompt_version": "per_object_removal_benefit_score_0_10_v13",
        "scene_count": 1,
    ...
    for object_id in OBJECT_IDS:
        for repeat_index, seed in enumerate(SEEDS, 1):
            rows.append({
                "run_id": (
                    f"v13__{SCENE_ID}__object_{object_id}__L2__C0_NA__"
